...
public class Main extends Application {
	...
	{
		window = stage;
		Image icon = new Image(getAbsPath("images","logo.Png"));
	...
	{
		File file = new File(getAbsPath("vod","intro.mp4"));
		...
		mediaPlayer.setOnEndOfMedia(new Runnable() {
			...
			@Override
			public void run() {
				playmusic("sound/background1.mp4");
				scene2(null);
		 ...
		 if (flag==null)
			{
				...
				Image image = new Image(getAbsPath("images","3Ghrl1.png"));
	...
	public void scene3()
	{
		...
		Image im1 = new Image(getAbsPath("images","captin.jpg"));
		ImageView iv1 = new ImageView(im1);
		iv1.setFitHeight(130);
		iv1.setFitWidth(145);
		
		Image im3 = new Image(getAbsPath("images","Deadpool.jpg"));
		ImageView iv3 = new ImageView(im3);
		iv3.setFitHeight(130);
		iv3.setFitWidth(145);
		
		Image im4 = new Image(getAbsPath("images","Dr Strange.jpg"));
		ImageView iv4 = new ImageView(im4);
		iv4.setFitHeight(130);
		iv4.setFitWidth(145);
		
		Image im5 = new Image(getAbsPath("images","Electro.png"));
		...
		Image im6 = new Image(getAbsPath("images","Ghost Rider.jpg"));
		ImageView iv6 = new ImageView(im6);
		iv6.setFitHeight(130);
		iv6.setFitWidth(145);
		
		Image im7 = new Image(getAbsPath("images","Hela.jpg"));
		ImageView iv7 = new ImageView(im7);
		iv7.setFitHeight(130);
		iv7.setFitWidth(145);
		
		Image im8 = new Image(getAbsPath("images","Hulk.jpg"));
		ImageView iv8 = new ImageView(im8);
		iv8.setFitHeight(130);
		iv8.setFitWidth(145);
		
		Image im9 = new Image(getAbsPath("images","Iceman.jpg"));
		...
		Image im14 = new Image(getAbsPath("images","Thor.jpg"));
		ImageView iv14 = new ImageView(im14);
		iv14.setFitHeight(130);
		iv14.setFitWidth(145);
		
		Image im15 = new Image(getAbsPath("images","Venom.jpg"));
		ImageView iv15 = new ImageView(im15);
		iv15.setFitHeight(130);
		iv15.setFitWidth(145);
		
		Image im16 = new Image(getAbsPath("images","Yellow Jacket.jpg"));
	...
	//	gp.setPadding(new Insets(10 ,10 ,10 ,10));
		...
		Image im2 = new Image(getAbsPath("images","m.png"));
			...
			if(secondte==3) {
				if(secondpl&&secondplled!=null) 
				{
					try {
						...
						playmusic("sound/Most Epic Music Ever_ _The Wolf And The Moon_ by BrunuhVille.mp4");
...
//		Button b = new Button("captin");
	...
	public void scene5() throws IOException, InterruptedException
	{
		...
		StackPane sp2 = new StackPane();
		sp2.setBackground(new Background(new BackgroundFill(Color.BLACK, CornerRadii.EMPTY, Insets.EMPTY)));
		Image image = new Image(getAbsPath("images","board7.png"));
		ImageView iv = new ImageView(image);
		iv.setFitWidth(800);
		iv.setFitHeight(600);
		...
		Image image2 = new Image(getAbsPath("images","board3.png"));
		...
		Image image3 = new Image(getAbsPath("images","shape2.png"));
		Image image4 = new Image(getAbsPath("images","shape2.png"));
		...
		Image image5 = new Image(getAbsPath("images","shape3.png"));
		Image image6 = new Image(getAbsPath("images","shape3.png"));
		...
		Image image7 = new Image(getAbsPath("images","shape2.png"));
		...
		Image image8 = new Image(getAbsPath("images","shape4.png"));
		...
		useleaderability.setBackground(new Background(	new BackgroundFill(Color.BLACK, CornerRadii.EMPTY, Insets.EMPTY)));
		...
		Image image9 = new Image(getAbsPath("images","shape4.png"));
		...
		useability.setBackground(new Background(	new BackgroundFill(Color.BLACK, CornerRadii.EMPTY, Insets.EMPTY)));
		...
		useability.setOnAction(e ->
		{
			...
			Image image10 = new Image(getAbsPath("images","shape4.png"));
			...
			move.setScaleX(1.2);
			move.setScaleY(1.5);
			move.setBackground( new Background(	new BackgroundFill(Color.BLACK, CornerRadii.EMPTY, Insets.EMPTY)));
		...
		move.setOnAction(e ->
		{
			...
			if((boolean) tm[0])
			{
				...
				Image image11 = new Image(getAbsPath("images","shape4.png"));
				...
				attack.setBackground(new Background(	new BackgroundFill(Color.BLACK, CornerRadii.EMPTY, Insets.EMPTY)));
				...
				Image image12 = new Image(getAbsPath("images","shape4.png"));
				...
				endturn.setBackground(new Background(	new BackgroundFill(Color.BLACK, CornerRadii.EMPTY, Insets.EMPTY)));
	...
	public void scene6()
	{
		...
		playmusic("sound/[FULL] Demon Slayer_ Kimetsu no Yaiba Episode 19 ED _ Ending 2 - _Kamado Tanjiro no Uta_ (Piano).mp4");
		 Image im = new Image(getAbsPath("images","end.png"));
	...
	public void loadchampionturn()
	{
		...
		while(!game.getTurnOrder().isEmpty()&&i!=3)
		{
			...
			arr.add(tmp);
			ImageView iv =new ImageView(new Image(getAbsPath("images",geticon(tmp.getName()))));
			iv.setFitHeight(85);
			iv.setFitWidth(75);
	...
	private String geticon(int x , int y)
	{
		if(game.getBoard()[x][y] instanceof Cover)
			return getAbsPath("images","shield.png");
		else
		{
			switch(((Champion)game.getBoard()[x][y]).getName())
			{
			case("Captain America"): return getAbsPath("images","captin.jpg");
			case("Deadpool"): return getAbsPath("images","Deadpool.jpg");
			case("Dr Strange") : return getAbsPath("images","Dr Strange.jpg");
			case("Electro"):return getAbsPath("images","Electro.png");
			case("Ghost Rider") : return getAbsPath("images","Ghost Rider.jpg");
			case("Hela") : return getAbsPath("images","Hela.jpg");
			case("Hulk"): return getAbsPath("images","Hulk.jpg");
			case("Iceman"):return getAbsPath("images","Iceman.jpg");
			case("Ironman"): return getAbsPath("images","Ironman.jpg");
			case("Loki"):return getAbsPath("images","Loki.jpg");
			case("Quicksilver"):return getAbsPath("images","Quicksilver.png");
			case("Spiderman"):return getAbsPath("images","Spiderman.jpg");
			case("Thor") :return getAbsPath("images","Thor.jpg");
			case("Venom"):return getAbsPath("images","Venom.jpg");
			default : return getAbsPath("images","Yellow Jacket.jpg");
